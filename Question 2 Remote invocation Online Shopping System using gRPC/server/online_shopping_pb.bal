...
public isolated client class OnlineShoppingServiceOrderStatusCaller {
    private final grpc:Caller caller;
    ...
    isolated remote function sendOrderStatus(OrderStatus response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextOrderStatus(ContextOrderStatus response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public isolated client class OnlineShoppingServiceOperationStatusCaller {
    private final grpc:Caller caller;
    ...
    isolated remote function sendOperationStatus(OperationStatus response) returns grpc:Error? {
        return self.caller->send(response);
    }

    isolated remote function sendContextOperationStatus(ContextOperationStatus response) returns grpc:Error? {
        return self.caller->send(response);
    }
...
public isolated client class OnlineShoppingServiceProductCodeCaller {
    private final grpc:Caller caller;
...
public isolated client class OnlineShoppingServiceProductCaller {
    private final grpc:Caller caller;
